...
public class RockInteractable : MonoBehaviour, IInteractable
{
    ...
    public string InteractionHint => "Mineirar Rocha";
    ...
    private void Awake()
    {
        ...
        if (rockSR != null && spriteAlive != null)
            rockSR.sprite = spriteAlive;
    }
    ...
    private IEnumerator FallRoutine()
    {
        ...
        if (rockSR != null && spriteStump != null)
            rockSR.sprite = spriteStump;
