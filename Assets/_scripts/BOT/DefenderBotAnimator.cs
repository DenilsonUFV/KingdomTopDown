...
/// <summary>
/// Controla as animações do BOT defensor (melee e arqueiro).
/// Lê o movimento de EnemyMovement e recebe chamadas diretas do DefenderBotBrain.
///
...
public class DefenderBotAnimator : MonoBehaviour
{
    // ─────────────────────────────────────────
    #region Hashes
    ...
    // ─────────────────────────────────────────
    #region API — chamada pelo DefenderBotBrain
